...
> Be patient! In ~3 mins your app is live, at your [app url](https://container--lr6ztc.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container--lr6ztc.containers.anotherwebservice.com/
...
```
git clone git@github.com:choice21hax/container--lr6ztc.git
cd container--lr6ztc
```
...
```
docker attach container--lr6ztc
```
